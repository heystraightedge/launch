...
describe('TextDecoder', () => {
  ...
  it('polyfills with no exceptions (without TextDecoder)', () => {
    ...
    expect(require('./textDecoder')).toBeDefined(); // eslint-disable-next-line @typescript-eslint/no-explicit-any,@typescript-eslint/no-unsafe-assignment,@typescript-eslint/no-unsafe-member-access
