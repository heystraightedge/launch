...
describe('encode', () => {
  ...
  it('can re-encode an address', () => {
    expect((0, _encode.default)('5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY', 68)).toEqual('7sL6eNJj5ZGV5cn3hhV2deRUsivXfBfMH76wCALCqWj1EKzv');
  });
  it('can re-encode an address to Polkadot live', () => {
    expect((0, _encode.default)('5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY', 0)).toEqual('15oF4uVJwmo4TdGW7VfQxNLavjCXviqxT9S1MgbjMNHr6Sp5');
  });
  ...
  it('encodes a 8-byte address', () => {
    expect((0, _encode.default)(new Uint8Array([42, 44, 10, 0, 0, 0, 0, 0]), 68)).toEqual('4q7qY5RBG7Z4wv');
  });
  it('encodes an 33-byte address', () => {
    expect((0, _encode.default)('0x03b9dc646dd71118e5f7fda681ad9eca36eb3ee96f344f582fbe7b5bcdebb13077')).toEqual('KWCv1L3QX9LDPwY4VzvLmarEmXjVJidUzZcinvVnmxAJJCBou');
  });
});