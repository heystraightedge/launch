...
class Keyring {
  ...
  addFromJson({
    ...
    return this.addFromAddress(address, meta, (0, _util.isHex)(encoded) ? (0, _util.hexToU8a)(encoded) : (0, _utilCrypto.base64Decode)(encoded), cryptoType, ignoreChecksum, encType);
  }
  /**
