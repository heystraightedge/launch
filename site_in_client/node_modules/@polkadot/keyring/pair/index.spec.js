...
describe('pair', () => {
  ...
  it('has a publicKey', () => {
    ...
    expect(keyring.alice.addressRaw).toEqual(new Uint8Array([209, 114, 167, 76, 218, 76, 134, 89, 18, 195, 43, 160, 168, 10, 87, 174, 105, 171, 174, 65, 14, 92, 203, 89, 222, 232, 78, 47, 68, 50, 219, 79]));
  });
  it('allows signing', () => {
  ...
  it('allows getting public key after decoding', () => {
    ...
    const pair = (0, _.default)({
      toSS58: _utilCrypto.encodeAddress,
      type: 'sr25519'
    }, {
  ...
  it('fails to sign when locked', () => {
    ...
    expect(() => pair.sign(new Uint8Array([0]))).toThrow('Cannot sign with a locked key pair');
  });
  describe('ethereum', () => {
    it('has a valid address from a known public', () => {
      const pair = (0, _.default)({
        toSS58: _utilCrypto.encodeAddress,
        type: 'ethereum'
      }, {
        publicKey: (0, _util.hexToU8a)('0x03b9dc646dd71118e5f7fda681ad9eca36eb3ee96f344f582fbe7b5bcdebb13077')
      });
      expect(pair.address).toEqual('0x4119b2e6c3Cb618F4f0B93ac77f9BeeC7FF02887');
      expect(pair.addressRaw).toEqual((0, _util.hexToU8a)('0x4119b2e6c3Cb618F4f0B93ac77f9BeeC7FF02887'));
    });
  });
});